...
Neste projeto eu recebi uma tabela não normalizada, a qual foi normalizada e populada, para que eu pudesse executar queries sobre ela com o intuito de encontrar as informações solicitadas.
...
```javascript
  ...
  git git@github.com:Humberto-Bonadiman/Mysql-One-For-All.git
```
...
4. Para visualizar os comandos **sql** utilizados você pode abrir os arquivos **desafioN.sql**, onde N vai de 1 à 11. Você também pode visualizar o arquivo **desafio1.json** que foi utilizado no requisito 1, no mesmo diretório dos arquivos **desafioN.sql**.
